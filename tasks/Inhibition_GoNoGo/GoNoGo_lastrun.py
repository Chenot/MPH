...
def setupData(expInfo, dataDir=None):
    ...
    thisExp = data.ExperimentHandler(
        ...
        originPath='E:\\OneDrive - ISAE-SUPAERO\\MPH\\tasks\\Inhibition_GoNoGo\\GoNoGo_lastrun.py',
...
def run(expInfo, thisExp, win, globalClock=None, thisSession=None):
    ...
    # Run 'Begin Routine' code from LSL_GoNoGo_start
    send_marker('GoNoGo_start')
    ...
    practiceTrials = data.TrialHandler(nReps=1, method='sequential', 
        ...
        trialList=data.importConditions('gonogo_task_scenario.csv', selection=selected_rows_practice),
    ...
    testblocks = data.TrialHandler(nReps=1.0, method='sequential', 
        extraInfo=expInfo, originPath=-1,
        trialList=data.importConditions('gonogo_task_scenario.csv', selection=scenario_df[(scenario_df['block'] == 'test') & (scenario_df['block_n'] == block_index)].index.tolist()),
    ...
    # Run 'Begin Routine' code from LSL_GoNoGo_end
    send_marker('GoNoGo_end')
