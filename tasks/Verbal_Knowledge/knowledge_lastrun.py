...
expName = 'Knowledge'  # from the Builder filename that created this script
...
def setupData(expInfo, dataDir=None):
    ...
    thisExp = data.ExperimentHandler(
        ...
        originPath='D:\\Google Drive\\Professionnel\\3_Post-doc_ISAE-MPH\\Experience_MPH\\project\\code\\PsychopyTasks\\Verbal_Knowledge\\knowledge_lastrun.py',
...
def run(expInfo, thisExp, win, globalClock=None, thisSession=None):
    ...
    TextInstructions = visual.TextStim(win=win, name='TextInstructions',
        text=None,
        font='Arial',
        pos=[0, 0], height=0.04, wrapWidth=1.55, ori=0, 
    ...
    stimulus = visual.TextStim(win=win, name='stimulus',
        text=None,
        font='Arial',
        pos=[0, 0.1], height=0.05, wrapWidth=1.2, ori=0, 
        color='white', colorSpace='rgb', opacity=1, 
        languageStyle='LTR',
        depth=0.0);
    ...
    trials = data.TrialHandler(nReps=1, method='sequential', 
        ...
        trialList=data.importConditions('knowledge.csv'),
    ...
    # Run 'Begin Routine' code from LSL_knowledge_end
    send_marker('Knowledge_end')
    end_task.keys = []
    end_task.rt = []
    _end_task_allKeys = []
    # keep track of which components have finished
